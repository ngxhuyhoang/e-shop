...
import { Text, View, TouchableOpacity, Image, TextInput, Button, StyleSheet, Alert } from 'react-native';
...
const InfoUser: React.FC = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View><Text style={{fontSize: 20, fontWeight: 'bold', marginBottom: 25}}>Cập nhật thông tin cá nhân</Text></View>
